...
const horizontalVideos = [
  { id: 1, title: "IMAGEFILME", src: "https://iframe.mediadelivery.net/embed/608059/acf90f1c-5826-44b8-9f7a-a7d3d025687d?autoplay=true&loop=true&muted=true&preload=true&responsive=true&controls=false&background=1" },
  { id: 2, title: "SOCIAL MEDIA", src: "https://iframe.mediadelivery.net/embed/608059/6287502a-4e24-488b-bab9-a8d53ed4ba6b?autoplay=true&loop=true&muted=true&preload=true&responsive=true&controls=false&background=1" },
  { id: 3, title: "EVENTS", src: "https://iframe.mediadelivery.net/embed/608059/1e5a10c8-f7eb-4b70-88d5-50d4eed0374d?autoplay=true&loop=true&muted=true&preload=true&responsive=true&controls=false&background=1" },
  { id: 4, title: "DOKUMENTATION", src: "https://iframe.mediadelivery.net/embed/608059/26391f32-e8be-4713-8882-8a8ce262f635?autoplay=true&loop=true&muted=true&preload=true&responsive=true&controls=false&background=1" },
  { id: 5, title: "CONTENT", src: "https://iframe.mediadelivery.net/embed/608059/81ea8caf-48f1-41f1-9fab-7f3e2da82b5f?autoplay=true&loop=true&muted=true&preload=true&responsive=true&controls=false&background=1" },
];
...
export function FilmProjects() {
  ...
  return (
    <section id="projects" ref={sectionRef} className="relative bg-black">
      ...
      {/* ===== HORIZONTALE VIDEOS SCROLL SECTION ===== */}
